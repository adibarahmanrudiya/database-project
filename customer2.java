...
public class customer2 {
    ...
    public static void main(String[] args) {
      /* */  try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/customer2", "root", ""); //Establishing a Connection
            ...
            ResultSet rs = st.executeQuery("select * from cust2");//Executing the SQL Query
            while (rs.next()) {//moves the cursor to the next row of the result set. If there are no more rows, it returns false, terminating the loop.
                System.out.println("C_ID=" + rs.getInt(1) );
                System.out.println("C_City=" + rs.getString(2) );
                System.out.println("C_Country=" + rs.getString(3) );
